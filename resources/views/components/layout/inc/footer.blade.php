@php
  ...
  $customers  = [
    url(Post::findCode('term-use')->link->pretty) => 'term use',
    url(Post::findCode('term-payment')->link->pretty) => 'term payment',
    url(Post::findCode('privacy-policy')->link->pretty) => 'privacy policy',
    url('review') =>  'review',
    url('faq')  =>  'faq',
  ];
